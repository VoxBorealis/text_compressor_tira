...
class FileService:
    ...
    def write_text_file(self, file, content):
        ...
        string variable. The name of the new file will
        be that of the given file.
    ...
    def write_code_table(self, file, code_table):
        ...
        Args:
            ...
            code_table (dict): Dictionary containing key, value pairs of
                               all the symbols and their respective codes.
        ...
        return self._file_repository.write_code_table(file_name,
                                                      code_table_swapped)
    ...
    def get_bin_file_from_original(self, file):
        return self._file_repository.get_bin_file_from_original(file)
